    ...
    return (
        <Container className="py-10 bg-[url('/images/bgs/product-bg.png')] bg-no-repeat bg-cover bg-center bg-c-light-slate bg-opacity-10" id="bookNow">
            <div className="text-center">
                ...
                <p className="text-sm text-c-novel w-[40%] mx-auto mt-4">New to the UK, big, colourful personalised greeting signs available to rent, suitable for all occasions both indoors and outdoors.</p>
            </div>
