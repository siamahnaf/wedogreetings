...
const Support = () => {
    return (
        <Container className="bg-[url('/images/about/bg.png')] bg-no-repeat bg-contain bg-left my-12 lg:bg-[url('/images/about/bg.png')] xxs:bg-none">
            <div className="grid grid-cols-2 lg:grid-cols-2 xxs:grid-cols-1 gap-10 py-8 items-center">
                <div>
                    {data.map((item, i) => (
                        <div className={`bg-white w-[75%] md:w-[75%] xxs:w-full my-6 shadow-3xl p-8 rounded-lg ${i % 2 !== 0 && "ml-14 md:ml-14 xxs:ml-0"}`} key={i}>
