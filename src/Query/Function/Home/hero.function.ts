...
export const GET_WEB_PRODUCTS = async (): Promise<WebProductData[]> => await (await fetch("https://wdg.teamdesk.net/secure/api/v2/90582/Web%20Product%20Listing/Default%20View/select.json?top=8", { headers }).then(res => res.json()));
