...
export const getServerSideProps: GetServerSideProps = async (ctx) => {
    ...
    //Fetching Data
    await queryClient.prefetchQuery({ queryKey: ["rentalTerms"], queryFn: GET_WEB_RENTAL_TERMS });
